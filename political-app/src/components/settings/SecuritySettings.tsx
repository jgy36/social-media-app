        ...
        <div className="border-t pt-6">
          ...
          <div className="bg-muted/30 p-4 rounded-md mb-4">
            <div className="flex items-start">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                your account. When enabled, you&apos;ll need your password and a
                verification code from your authentication app to sign in.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            {is2FAEnabled ? (
              ...
              <Button variant="outline" size="sm" onClick={handleInit2FA}>
                Enable 2FA
              </Button>
            )}
          </div>
            ...
            <div className="space-y-4">
              ...
              {twoFAData?.qrCodeUrl && (
                <div className="flex justify-center my-4">
                  {qrCodeLoading ? (
                    <div className="w-[200px] h-[200px] border p-2 rounded-md flex items-center justify-center">
                      <Loader2 className="h-8 w-8 animate-spin" />
                    </div>
                  ) : qrCodeError ? (
                    <div className="w-[200px] h-[200px] border p-2 rounded-md flex items-center justify-center text-center text-sm text-muted-foreground">
                      <p>
                        Failed to load QR code. Please use the manual entry key
                        below.
                      </p>
                    </div>
                  ) : (
