...
public interface PostRepository extends JpaRepository<Post, Long> {
     ...
     * Fixed: Using 'author' instead of 'user' to match your Post entity
     */
    List<Post> findByAuthorOrderByCreatedAtDesc(User author);

    /**
     * Alternative method name for backward compatibility with PrivacyService
     * This delegates to the correct method above
     */
    ...
    /**
     * Alternative count method for backward compatibility
     */
