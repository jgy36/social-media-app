...
import { Users, ChevronLeft, ChevronRight, Home, Plus } from "lucide-react";
...
const CommunitySidebar = () => {
  ...
  // Add this to check for admin role
  ...
  return (
    ...
    >
      <div className="p-2 flex flex-col h-full">
        ...
        {/* Only show Create Community button for admins */}
        {isAdmin && (
          <Link
            href="#"
