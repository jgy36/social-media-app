      ...
      <View className="bg-white dark:bg-gray-900 rounded-t-3xl max-h-[90%] p-6">
        ...
        {errorMessage && (
          <View className="bg-red-100 dark:bg-red-900/20 rounded-lg p-3 mb-4">
            <Text className="text-red-700 dark:text-red-300">{errorMessage}</Text>
          </View>
        )}
        ...
        <View className="flex-row justify-between items-center mb-4">
          <Text className="text-sm text-gray-600 dark:text-gray-400">
            <Text className="font-medium">{selectedBadges.length}</Text> of{' '}
            <Text className="font-medium">10</Text> badges selected
          </Text>
          <Pressable 
          ...
          >
            <Text className="text-sm text-gray-600 dark:text-gray-400">Clear All</Text>
          </Pressable>
        </View>
              ...
              <View className="flex-row gap-2">
                {selectedBadges.map(badgeId => {
                  ...
                  return (
                    ...
                    >
                      <Text className="text-white text-sm">{badge.name}</Text>
            ...
            {getBadgesByCategory(activeCategory).map(badge => {
              ...
              return (
                <Pressable
                  ...
                  style={{ minWidth: '45%' }}
                >
                  {isSelected && <MaterialIcons name="check" size={16} color="#6b7280" />}
        ...
        <View className="flex-row gap-3 mt-4">
          ...
          >
            {isSubmitting && <MaterialIcons name="refresh" size={16} color="#6b7280" />}
